...
function create_each_block_3(ctx) {
	...
	return {
		...
		h() {
			attr(a, "class", "nav-item svelte-ktwy4p");
...
function create_else_block_2(ctx) {
	...
	return {
		...
		h() {
			attr(a, "class", "button label-button svelte-ktwy4p");
			attr(a, "href", a_href_value = /*link*/ ctx[8].url);
		},
		m(target, anchor) {
			insert_hydration(target, a, anchor);
...
function create_else_block_1(ctx) {
	...
	return {
		...
		h() {
			attr(a, "class", "button icon-button svelte-ktwy4p");
			attr(a, "href", a_href_value = /*link*/ ctx[8].url);
		},
		m(target, anchor) {
			insert_hydration(target, a, anchor);
...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			attr(hr0, "class", "svelte-ktwy4p");
			attr(hr1, "class", "svelte-ktwy4p");
			attr(button, "id", "close");
			attr(button, "aria-label", "Close Navigation");
			attr(button, "class", "svelte-ktwy4p");
			attr(nav, "id", "mobile-nav");
			attr(nav, "class", "svelte-ktwy4p");
		},
		m(target, anchor) {
...
function create_else_block(ctx) {
	...
	return {
		...
		h() {
			attr(span, "class", "logo svelte-ktwy4p");
		},
		m(target, anchor) {
			insert_hydration(target, span, anchor);
			append_hydration(span, t);
...
function create_if_block_1(ctx) {
	...
	return {
		...
		h() {
			attr(img, "class", "logo svelte-ktwy4p");
			if (!src_url_equal(img.src, img_src_value = /*logo*/ ctx[1].image.url)) attr(img, "src", img_src_value);
			attr(img, "alt", img_alt_value = /*logo*/ ctx[1].image.alt);
		},
		m(target, anchor) {
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(a, "href", "/");
			attr(a, "class", "logo svelte-ktwy4p");
			set_style(a, "--size", style___size);
			attr(div0, "class", "nav-divider svelte-ktwy4p");
			attr(button, "id", "open");
			attr(button, "aria-label", "Открыть навигацию");
			attr(button, "class", "svelte-ktwy4p");
			attr(nav, "class", "svelte-ktwy4p");
			attr(div1, "class", "desktop-nav svelte-ktwy4p");
			attr(div2, "class", "section-container svelte-ktwy4p");
			attr(header, "class", "svelte-ktwy4p");
		},
		m(target, anchor) {
